...
const CLIENT_ID = "1615ccbe5065426d808b8df709bd5b31";
const CLIENT_SECRET = "046ab116991047e988aece23528b49b2";
...
const userSelfURL = "https://api.instagram.com/v1/users/self"

/* SIMPLE ROUTE */

app.get("/instagramOAuth", (req, res) => {
...
app.get("/", (req, res) => {
    ...
    if (code) {
        ...
        request.post({
            ...
            const selfURL = userSelfURL + `?access_token=${JSON.parse(body).access_token}`;
